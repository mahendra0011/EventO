export const INDIAN_CITY_GROUPS = [
  {
...
export const INDIAN_CITY_OPTIONS = INDIAN_CITY_GROUPS.flatMap((group) =>
  group.cities.map((city) => ({
    city,
    state: group.state,
    value: `${city}|${group.state}`
  }))
);

export const findCityOption = (city, state) => INDIAN_CITY_OPTIONS.find((option) => (
  option.city === city && (!state || option.state === state)
));
