          ...
          <div className="w-full max-w-xl">
            <div className="surface-panel p-8">
              <div className="mb-8 text-center">
                ...
                <p className="mt-2 text-slate-500">Start booking events or register as a host to publish your own.</p>
              </div>
              ...
              <label className="mb-6 flex cursor-pointer items-center justify-between rounded-lg border border-slate-200 bg-slate-50 p-4">
                <span className="flex items-center gap-3">
                  ...
                  <span>
                    <span className="block text-sm font-bold text-slate-900">Register as host</span>
                    <span className="text-xs text-slate-500">Create events and manage attendees</span>
                  </span>
                </span>
                <input
                  type="checkbox"
